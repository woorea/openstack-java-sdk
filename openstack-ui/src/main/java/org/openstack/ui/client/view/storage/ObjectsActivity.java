...
public class ObjectsActivity extends AbstractActivity implements ObjectsView.Presenter {
	
	private static final ObjectsView VIEW = new ObjectsView();
	...
	public ObjectsActivity(OpenStackPlace place) {
		this.place = place;
	}
