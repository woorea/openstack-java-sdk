...
public class TenantResource extends Resource {
	...
	private ServersResource servers;
	...
	private SecurityGroupsResource securityGroups;
	...
	public ServersResource servers() {
		if(servers == null) {
			servers = new ServersResource(client, new StringBuilder(resource).append("/servers").toString());
		}
		return servers;
	}
	...
	public SecurityGroupsResource securityGroups() {
		if(securityGroups == null) {
			securityGroups = new SecurityGroupsResource(client, new StringBuilder(resource).append("/os-security-groups").toString());
		}
