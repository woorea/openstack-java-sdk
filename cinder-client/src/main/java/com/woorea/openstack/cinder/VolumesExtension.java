...
public class VolumesExtension {
    ...
    public InitializeConnection initializeConnection(String id) {
        return new InitializeConnection(id);
    }
    ...
    public class InitializeConnection extends OpenStackRequest<ConnectionInfo> {
        ...
        public InitializeConnection(String id) {
            super(CLIENT, HttpMethod.POST, new StringBuilder("/volumes/")
                    .append(id).append("/action").toString(),
                    Entity.json(new ConnectionForInitialize()), ConnectionInfo.class);
        }
